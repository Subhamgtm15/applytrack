...
export default function Upcoming({
  ...
  return (
    <article className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-3 transition hover:-translate-y-0.5 hover:bg-white hover:shadow-sm">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <span className={`rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] ring-1 ${statusClasses}`}>
          {status}
        </span>
      </div>
    </article>
