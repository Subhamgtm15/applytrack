...
export default function StatCard({ title, value, subtitle, icon: LucideIcon, iconBg }: StatCardProps) {
    return (
        <article className="min-w-0 flex-1 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-md text-slate-900 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200">
            <div className="flex items-start justify-between gap-4">
                ...
                <div className={`shrink-0 rounded-2xl p-3 ${iconBg ?? "bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-200"}`}>
